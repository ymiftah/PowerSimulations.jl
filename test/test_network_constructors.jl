...
# Both area-aggregated network models key CopperPlateBalanceConstraint by PSY.Area, so their
# duals must be keyed by PSY.Area too. A mismatch only surfaces at solve!.
@testset "2 Areas area-aggregated PowerModel duals" begin
